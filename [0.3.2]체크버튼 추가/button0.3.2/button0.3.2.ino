...
NexPicture recipeCheck1 = NexPicture(1, 16, "p1");
NexPicture recipeCheck2 = NexPicture(1, 17, "p2");
NexPicture recipeCheck3 = NexPicture(1, 18, "p3");
NexPicture recipeCheck4 = NexPicture(1, 19, "p4");
NexPicture recipeCheck5 = NexPicture(1, 20, "p5");
...
void UserMenuRecipe0PopCallback(void *ptr){ //UserMenu의 레시피0버튼 눌렸다 떼어질 때의 이벤트 핸들러.
  ...
  String msg = loadRecipe(rid);  //    {"filt 10,wait 5,Pour 5,wait 5,pour 5"},
  ...
  recipeCheck1.setPic(recipeCheckImg);
  setSound();
}
